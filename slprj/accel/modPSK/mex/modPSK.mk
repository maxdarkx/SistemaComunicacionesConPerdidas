...
MODEL                = modPSK
MODULES              = modPSK_acc.c modPSK_acc_data.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/modPSK_acc.mexw64
MAKEFILE             = modPSK.mk
...
MODELLIB                  = modPSK_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = modPSK_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/modPSK \
...
modPSK_acc.obj : $(START_DIR)/slprj/accel/modPSK/modPSK_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/modPSK/modPSK_acc.c

modPSK_acc_data.obj : $(START_DIR)/slprj/accel/modPSK/modPSK_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/modPSK/modPSK_acc_data.c
