...
MODEL                = modPSK_mod2
MODULES              = modPSK_mod2_acc.c modPSK_mod2_acc_data.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/modPSK_mod2_acc.mexw64
MAKEFILE             = modPSK_mod2.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2022a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2022a
START_DIR            = C:/Users/max_d/DOCUME~1/MATLAB/LABORA~2
S_FUNCTIONS_LIB      = 
NUMST                = 3
NCSTATES             = 26
...
MODELLIB                  = modPSK_mod2_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = modPSK_mod2_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/modPSK_mod2 \
...
modPSK_mod2_acc.obj : $(START_DIR)/slprj/accel/modPSK_mod2/modPSK_mod2_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/modPSK_mod2/modPSK_mod2_acc.c

modPSK_mod2_acc_data.obj : $(START_DIR)/slprj/accel/modPSK_mod2/modPSK_mod2_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/modPSK_mod2/modPSK_mod2_acc_data.c
